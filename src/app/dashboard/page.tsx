...
const ALL_QUICK_ACTIONS = [
    ...
    },
    {
        ...
        roles: ['MANAGER', 'ADMIN', 'SUPER_ADMIN'] as UserRole[], // Only managers and admins can verify
    },
    {
        id: 'inventory',
        label: 'Inventory',
    ...
    },
    {
        ...
        roles: ['MANAGER', 'ADMIN', 'SUPER_ADMIN'] as UserRole[], // Only managers and admins can add items
    },
    {
        id: 'shoots',
        label: 'Shoots',
    ...
    },
    {
        ...
        roles: ['ADMIN', 'SUPER_ADMIN'] as UserRole[], // Only admins can manage users
    },
    {
        id: 'notify',
        label: 'Notify',
        ...
        roles: ['ADMIN', 'SUPER_ADMIN'] as UserRole[], // Only admins can send notifications
    },
    {
        id: 'activity',
        label: 'Activity',
        ...
        roles: ['ADMIN', 'SUPER_ADMIN'] as UserRole[], // Only admins can view activity logs
    },
    {
        id: 'departments',
        label: 'Departments',
        ...
        roles: ['SUPER_ADMIN'] as UserRole[], // Only super admin can manage departments
    },
    {
        id: 'settings',
        label: 'Settings',
            ...
            <div className="max-w-6xl mx-auto animate-fade-in">
                ...
                <div className="mb-8">
                    <h1 className="text-3xl sm:text-4xl font-bold text-[#1d1d1f] dark:text-gray-100">
                        {department ? department.name : 'Global Dashboard'}
                    </h1>
                    <p className="text-[15px] text-[#86868b] dark:text-gray-400 mt-1">Overview of {department ? 'department' : 'all'} inventory</p>
                </div>

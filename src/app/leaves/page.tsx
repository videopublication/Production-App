...
export default function LeavesPage() {
    ...
    return (
        <div className="px-4 py-6 sm:p-6 space-y-6 max-w-5xl mx-auto min-h-[calc(100vh-80px)] pb-24 md:pb-6">
                ...
                <div className="bg-white dark:bg-[#1c1c1e] p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 animate-in fade-in slide-in-from-top-4">
                    ...
                    <form onSubmit={handleApplySubmit} className="space-y-4">
                        ...
                        <div className="flex justify-end gap-3">
                            <Button variant="outline" type="button" onClick={() => setIsApplying(false)}>Cancel</Button>

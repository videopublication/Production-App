...
export default function UserManagementPage() {
    ...
    const roleBadge = (role: string) => {
        const styles: Record<string, string> = {
            ...
            MANAGER: 'bg-primary dark:bg-primary/20 text-primary dark:text-primary',
                                ...
                                >
                                    ...
                                    <div className="hidden sm:flex flex-col lg:flex-row lg:items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-3 min-w-0 flex-1 pr-4">
                                                ...
                                                <div className="min-w-0">
                                                    <div className="flex items-center gap-1.5">
                                                        ...
                                                        {user?.id === u.id && <span className="px-1.5 py-0.5 bg-primary dark:bg-primary/20 text-primary dark:text-primary text-[9px] font-bold rounded-full shrink-0">YOU</span>}
                                                    </div>
                                        ...
                                        {user?.id !== u.id ? (
                                            ...
                                            {/* Role Changer */}
                                            <select
                                                className="bg-gray-100 dark:bg-gray-800 border-0 rounded-lg px-2.5 py-1.5 text-xs font-medium cursor-pointer focus:ring-2 focus:ring-primary text-gray-900 dark:text-gray-100 w-[140px] truncate"
                                                value={u.role}
                                            ...
                                            {user?.role === 'SUPER_ADMIN' && u.role !== 'SUPER_ADMIN' && (
                                                <select
                                                    className="bg-gray-100 dark:bg-gray-800 border-0 rounded-lg px-2.5 py-1.5 text-xs font-medium cursor-pointer focus:ring-2 focus:ring-primary text-gray-900 dark:text-gray-100 w-[160px] truncate"
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-1.5 mb-0.5">
                                                    ...
                                                    {user?.id === u.id && <span className="px-1.5 py-0.5 bg-primary dark:bg-primary/20 text-primary text-[9px] font-bold rounded-full shrink-0">YOU</span>}
                                                </div>
                                                <p className="text-xs text-gray-400 truncate">{u.email}</p>

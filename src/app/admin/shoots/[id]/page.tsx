            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto mt-4 sm:mt-0">
                    <button
                        ...
                        className="flex-none flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg font-semibold transition-all shadow-sm hover:shadow-md active:scale-95 bg-[#25D366] hover:bg-[#128C7E] text-white border border-transparent"

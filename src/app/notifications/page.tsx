...
export default function NotificationsPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto animate-fade-in">
            ...
            <div className="mb-4 p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border border-blue-100/50 shadow-sm">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-gray-800 flex items-center gap-2">
                        ...
                        <p className="text-sm text-gray-500 mt-1 ml-10">
                            {unreadCount > 0 ? (
                                <span className="font-medium text-blue-600">{unreadCount} new</span>
                            ) : (
                    ...
                    {notifications.length > 0 && (
                        <div className="relative">
                            <button
                                ...
                                className="p-2.5 rounded-xl bg-white/80 hover:bg-white border border-gray-200/50 shadow-sm transition-colors"
                            >
                            ...
                            {showActions && (
                                <>
                                    ...
                                    <div className="absolute right-0 top-full mt-2 w-52 bg-white border border-gray-100 rounded-xl shadow-xl z-20 py-1.5 animate-in fade-in slide-in-from-top-2 duration-150 overflow-hidden">
                                        {unreadCount > 0 && (
                                            <button
                                                onClick={markAllRead}
                ...
                <Card className="overflow-hidden">
                    <div className="divide-y divide-border">
                        {filteredNotifications.map((notification) => (
                            ...
                            >
                                <div className={`
                                    p-4 transition-all hover:bg-muted/50 relative
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0 py-0.5">
                                            <div className="flex items-baseline justify-between gap-2">
                                                <h3 className={`text-sm leading-snug ${!notification.read ? 'font-semibold text-gray-900' : 'font-medium text-gray-600'}`}>
                                                    {notification.title}
                                                </h3>
                                        ...
                                        <button
                                            ...
                                            className="p-2 rounded-lg bg-gray-100 hover:bg-red-100 text-gray-400 hover:text-red-600 transition-all shrink-0 self-center"
                                            title="Delete"
                                        >

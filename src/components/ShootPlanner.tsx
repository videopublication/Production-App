                                        ...
                                        return (
                                            ...
                                            >
                                                            ...
                                                            {dayConflicts.map(conflict => (
                                                                ...
                                                                >
                                                                    ...
                                                                    {[conflict.first, conflict.second].map(item => (
                                                                        <div
                                                                            key={getPlannerItemKey(item)}
                                                                            className="mt-1 grid grid-cols-[82px_1fr] gap-2 rounded-md bg-red-100/70 px-2 py-1.5 dark:bg-red-950/50"
                                                                        >
                                                ...
                                                <div className={hasSplitTimeline
                                                    ? 'grid gap-4 p-3 sm:p-4 xl:grid-cols-[320px_1fr] xl:items-start'

...
export const SplashScreen = () => {
    return (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background">
            {/* Background Effects */}
            <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-500/10 via-transparent to-transparent opacity-50" />
            ...
            <div className="relative z-10 flex flex-col items-center animate-in fade-in zoom-in-95 duration-700">
                ...
                <div className="relative w-32 h-32 mb-8 flex items-center justify-center">
                    ...
                    {/* Logo Image */}
                    <div className="relative w-28 h-28 bg-white dark:bg-white/10 backdrop-blur-sm rounded-3xl border border-gray-200 dark:border-white/10 p-4 shadow-xl flex items-center justify-center">
                        <img
                            src="/logo.png"
                            alt="Brand Logo"

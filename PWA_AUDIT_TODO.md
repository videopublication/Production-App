...
- [ ] **Fix Viewport Zoom** (`src/app/layout.tsx`)
...
- [ ] **Robust iPad Detection** (`src/components/PWAInstallPrompt.tsx`)
...
- [ ] **Emergency Cache Clear** (New Feature)
...
### 4. ⚙️ Configuration
- [ ] **Manifest Orientation** (`public/manifest.json`)
